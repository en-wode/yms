<template>
    <div class="table">
        ...
        <el-table :data="book" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange" stripe >
            <el-table-column  label="序号" prop="bookid" sortable>
            </el-table-column>
            <el-table-column  label="QQ号" prop="bookid" >
            </el-table-column>
            <el-table-column  label="身份证号" prop="bookid" >
            </el-table-column>
            <el-table-column  label="手机号" width="100" prop="booknum" >
            </el-table-column>
            <el-table-column  label="添加人" width="100" prop="booknum" >
            </el-table-column>
            <el-table-column  label="添加原因" width="100" prop="booklz">
            </el-table-column>
            <el-table-column  label="添加时间" width="100" prop="booklz">
            </el-table-column>
            <el-table-column label="操作" >
                <template slot-scope="scope">
                    <el-popover trigger="hover" placement="bottom">
                        ...
                        <div class="caozuo">
                            <p class="caozuo" @click="handleClick(scope.row)">删除</p>
                            <p class="caozuo" @click="subscripte(scope.row)">修改</p>
                        </div>
                    </el-popover>
                </template>
            </el-table-column>
