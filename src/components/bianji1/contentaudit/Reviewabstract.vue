<template lang="html">
  <div class="table">
    ...
    <el-table :data="book" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange" stripe >
      <el-table-column  label="序号" prop="bookid" >
      </el-table-column>
      <el-table-column  label="内容" prop="bookid" >
      ...
      <el-table-column  label="时间" width="160" prop="booksr" sortable>
      </el-table-column>
        ...
        <template slot-scope="scope">
          <el-popover trigger="hover" placement="bottom">
            ...
            <div class="caozuo">
              ...
              <p class="caozuo" @click="subscripte(scope.row)">不通过</p>
            </div>
          </el-popover>
        </template>
      </el-table-column>
