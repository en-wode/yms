<template lang="html">
  <div class="table">
    ...
    <el-table :data="book" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange" stripe >
      <el-table-column  label="章节名" prop="bookname" width="280">
      </el-table-column>
      <el-table-column  label="书号（点击书号可看所有）" prop="bookid" width="120" >
      </el-table-column>
      <el-table-column  label="设定时间" width="160" prop="booktime" >
      </el-table-column>
      <el-table-column  label="状态" width="160" prop="bookxs" >
      </el-table-column>
      <el-table-column  label="信息"  prop="booksr" >
      </el-table-column>
