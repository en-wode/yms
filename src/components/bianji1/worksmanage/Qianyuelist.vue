<template>
  <div class="table">
    ...
    <el-table :data="book" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange" stripe >
      ...
      <el-table-column label="签约时间" width="320" prop="bookbreak">
      </el-table-column>
      <el-table-column label="签约编辑" width="320" prop="bookbreak">
      </el-table-column>
      <el-table-column label="操作" width="320" prop="bookbreak">
        <template slot-scope="scope">
          <el-popover trigger="hover" placement="bottom">
            ...
            <div class="caozuo">
              <p class="caozuo" @click="handleClick(scope.row)">查看合同详细</p>
              <p class="caozuo" @click="subscripte(scope.row)">点击初审通过</p>
              <p class="caozuo">点击拒绝</p>
              <p class="caozuo">删除该签约信息</p>
            </div>
          </el-popover>
        </template>
      </el-table-column>
