<template>
  <div class="table">
    ...
    <el-table :data="book" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange" stripe v-loading="loading" fullscreen="true">
      <el-table-column label="书号" prop="bookauthor" width="100">
      </el-table-column>
      <el-table-column  label="书名"  prop="booknum" >
      </el-table-column>
      <el-table-column  label="字数" width="100" prop="booknum" >
      </el-table-column>
      <el-table-column  label="金额（元）" width="100" prop="booknum" >
      </el-table-column>
      <el-table-column  label="结算时间" prop="booknum" >
      </el-table-column>
      <el-table-column  label="操作" width="110" prop="bookxs" sortable>
      </el-table-column>
    </el-table>
    <!--tab表格end-->
    <!--弹框-->
