<template>
  <div class="table">
    ...
    <el-table :data="book" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange" stripe v-loading="loading" fullscreen="true">
      ...
      <el-table-column  label="用户uid" prop="bookid" sortable width="80" >
      </el-table-column>
      <el-table-column  label="时间" prop="bookid" sortable width="80" >
      </el-table-column>
      <el-table-column  label="书号" prop="bookid" sortable width="80" >
      </el-table-column>
      <el-table-column  label="标题" prop="bookid" sortable width="80" >
      </el-table-column>
      ...
      <el-table-column  label="违禁词" width="100" prop="bookclass">
      </el-table-column>
