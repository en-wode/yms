<template>
  <div class="table">
    ...
    <el-table :data="book" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange" stripe v-loading="loading" fullscreen="true">
      ...
      <el-table-column  label="书评ID" prop="bookid" sortable width="80" >
      </el-table-column>
      ...
      <el-table-column label="昵称/点击可查看TA全部回复" width="320">
        <template slot-scope="scope">
          <el-popover >
            <div slot="reference" class="name-wrapper">
      ...
      <el-table-column  label="回复时间" width="100" prop="bookclass">
      </el-table-column>
