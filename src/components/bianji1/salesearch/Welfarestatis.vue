  ...
  <div class="table">
    ...
    <div class="handle-box">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>男频</el-breadcrumb-item>
        <el-breadcrumb-item>女频</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="handle-box">
    ...
    <el-table :data="book" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange" stripe v-loading="loading" fullscreen="true">
      <el-table-column  label="书号" prop="bookid" sortable width="280" >
      </el-table-column>
      <el-table-column  label="书名" prop="booksr">
      </el-table-column>
      <el-table-column  label="平均订阅数" width="280" prop="bookclass">
      </el-table-column>
    </el-table>
    <!--tab表格end-->
    <!--弹框-->
