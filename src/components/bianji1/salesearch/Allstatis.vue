      ...
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        <div>
          <el-breadcrumb separator="/">
            <el-breadcrumb-item>昨天</el-breadcrumb-item>
            <el-breadcrumb-item>本周</el-breadcrumb-item>
            <el-breadcrumb-item>上周</el-breadcrumb-item>
            <el-breadcrumb-item>本月</el-breadcrumb-item>
            <el-breadcrumb-item>上月</el-breadcrumb-item>
            <el-breadcrumb-item>总均</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
      </el-form>
    </div>
