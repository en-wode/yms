<template>
  <div>
    ...
    <el-table :data="book" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange" stripe v-loading="loading" fullscreen="true">
      ...
      <el-table-column label="用户" width="320" prop="bookname">
      </el-table-column>
      <el-table-column label="充值时间" width="320" prop="bookbreak">
      </el-table-column>
      <el-table-column  label="支付方法" width="160" prop="booksr">
      </el-table-column>
      <el-table-column  label="金额" width="210" prop="bookxs">
      </el-table-column>
      <el-table-column  label="确认" width="100" prop="bookclass">
      </el-table-column>
      <el-table-column  label="来源渠道" width="100" prop="booknum" >
      </el-table-column>
      </el-table-column>
