<template>
  <div>
    ...
    <div class="pagination">
      ...
      <div>
        <el-radio-group v-model="selecttags" size="small">
          <el-radio-button v-for="tags in fulitags" :label="tags" :key="tags">{{tags}}</el-radio-button>
        </el-radio-group>
      </div>
    </div>
    <!--分页end-->
